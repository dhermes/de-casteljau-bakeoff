...
cdef extern void BAKEOFF_OPT_do1(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_do2(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_do3(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_forall1(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_forall2(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_forall3(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_serial(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_serial_inner(
    const int* num_nodes, const int* dimension, const double* nodes,
    const double* s_val, double* evaluated)
cdef extern void BAKEOFF_OPT_spread1(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_spread2(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_spread3(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_vs_algorithm32(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
cdef extern void BAKEOFF_OPT_vs_algorithm53(
    const int* num_nodes, const int* dimension, const double* nodes,
    const int* num_vals, const double* s_vals, double* evaluated)
